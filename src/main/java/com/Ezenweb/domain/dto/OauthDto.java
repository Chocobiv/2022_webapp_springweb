...
public class OauthDto {
    ...
    public static OauthDto ofKakao(String registrationId,String oauth2UserInfo,Map<String,Object> attributes){
        //1. 회원정보 호출
        Map<String,Object> kakao_account = (Map<String, Object>) attributes.get(oauth2UserInfo);//kakao_account->email
        Map<String,Object> profile = (Map<String, Object>) kakao_account.get("profile");//profile->nickname 때문에
